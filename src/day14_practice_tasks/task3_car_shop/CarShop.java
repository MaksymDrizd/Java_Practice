...
public class CarShop {
    ...
    public static void main(String[] args) {
        ...
        for (Car car : cars) {
            if ((car instanceof Honda && car.getYear() > 2009 && car.getYear() < 2012) ||
            (car instanceof Audi && car.getYear() > 2014 && car.getYear() < 2020) ||
                    (car instanceof Tesla && car.getYear() > 2014 && car.getYear() < 2017)){
        ...
        Car maxPrice = cars[0];
        for (Car car : cars) {
            if (car.getPrice() > maxPrice.getPrice()){
                maxPrice = car;
            }
        }
        ...
        Car minPrice = cars[0];
        for (Car car : cars) {
            if (car.getPrice() < minPrice.getPrice()){
                minPrice = car;
            }
        }
        System.out.println("Car with lowest price - " + minPrice);
        System.out.println("--------------------------");
